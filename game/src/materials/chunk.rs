...
impl engine::GlobalMaterial for GlobalMaterial {
    fn register(render_graph: &mut engine::RenderGraphWrapper<'_>) -> Self
        where Self: Sized,
    {
        let shader_code = resource_str!("src/materials/chunk_material.wgsl");
                ...
                vertex: wgpu::VertexState {
                    ...
                    buffers: &[
                        Some(wgpu::VertexBufferLayout {
                            ...
                            attributes: &[
                                wgpu::VertexAttribute { format: wgpu::VertexFormat::Float32x3, offset: 0x00, shader_location: 0 },
                                wgpu::VertexAttribute { format: wgpu::VertexFormat::Float32x2, offset: 0x0C, shader_location: 1 },
                                wgpu::VertexAttribute { format: wgpu::VertexFormat::Uint32   , offset: 0x14, shader_location: 2 },
                            ],
                        })
                    ],
                },
